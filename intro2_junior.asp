...
response.cookies("Backurl")="../../../../mylesson/intro2_junior.asp"
%>
<!DOCTYPE html>
<html lang="en">
	<head>
      ...
      /* ^ scrollbar 是否永遠顥示的跟據 ^ */
		...
		<script src="./2020/js/cpn_2_junior.js?<%=Timer%>"></script>
		<!---->
		...
		<div id="content">
			...
			<div class="wrapper" id="app">
				...
				<div id="foo">
					...
					<div class="f2"><span class="f2-1">服務時間：週一～週日14:00~17:30、18:30~22:00 | 02-2523-9777 / 0800-023-777
							(限市話)</span><span class="f2-2">{{copyright}}</span></div>
				</div>
			</div>
			<div id="sidebar">
